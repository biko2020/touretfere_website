...
<section class="section swiper-container swiper-slider swiper-slider-classic" data-loop="false" data-autoplay="5000"
  ...
  <div class="swiper-wrapper text-center">
    <!-- image banniere-->
    <div class="swiper-slide context-dark" data-slide-bg="assets/images/fabrication/banniere-reducteur.svg">
  ...
  <div class="container-fluid">
    ...
    <div class="main-title">
      ...
      <p class="texte-enrenage">
        Notre entreprise se concentre sur la création et la production de pièces de transmission pour l'industrie. Ces
        pièces comprennent des réducteurs, des engrenages, des vérins mécaniques, des pompes, et bien plus encore. Nous
        sommes en mesure de fournir des solutions sur mesure pour divers secteurs tels que le fere, le plastique,
        l'acier, l'aluminium, les bancs d'essai, et bien d'autres encore.
      </p>
    </div>
    <div class="space">
      </br>
    ...
    <div class="row row-sm row-30">
      ...
      <div class="col col-sm col-30">
        ...
        <div class="red-curve-text">
          <p>Nous sommes des fabricants de réducteurs industriels spécialisés dans la création de solutions complètes
            pour répondre aux besoins de nos clients en matière de transmission. Nous proposons des réducteurs sur
            mesure pour différents secteurs tels que la manutention, la construction, la production d'énergie,
            l'agriculture, l'exploitation minière et bien d'autres encore. Nos réducteurs industriels sont conçus pour
            offrir une performance fiable, une durée de vie prolongée et une efficacité énergétique optimale. Nous
            travaillons en étroite collaboration avec nos clients pour comprendre leurs besoins et leur fournir des
            solutions de réducteurs industriels personnalisées qui répondent à leurs exigences spécifiques. Qu'il
            s'agisse de nouveaux projets de conception ou de rénovations, nous sommes là pour fournir des réducteurs de
            transmission de qualité supérieure. </p>
