...
class Usinage extends HTMLElement {
  connectedCallback(){
    this.innerHTML = `

    <!-- section fabrication Usinage submenu -->
    ...
    <div class="row row-sm row-30">
        ...
        <div class="red-curve-text">
          <h5>Le mortaisage</h5>
            ...
            <p>Notre entreprise est spécialisée dans le mortaisage et utilise des techniques avancées pour offrir à ses clients des solutions innovantes adaptées à leurs projets sur mesure et à leurs besoins spécifiques.</p>
          </div>
        </div>  
    </div>
  </div>
    ...
    <div class="row row-sm row-30">
        ...
        <div class="red-curve-text">
          <h5>Le rodage</h5>
            ...
            <p>Tour et Fere propose des services de rodage pour les pièces de précision, offrant ainsi à ses clients des surfaces planes et régulières pour leurs besoins industriels.</p>
          </div>
        </div>  
    </div>
  </div>
...
customElements.define("include-fab-usinage", Usinage);